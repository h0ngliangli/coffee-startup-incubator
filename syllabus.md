...
The following is a preliminary list of materials and estimated costs. This will be refined as we develop the program and secure partnerships.

Barista aprons, name tags, and caps.
    

| Category         | Item                | Estimated Cost | Notes                       |
| ---------------- | ------------------- | -------------- | --------------------------- |
| Coffee equipment | TBD                 | TBD            | Based on budget and needs   |
| Supplies         | Cups, napkins, etc. | TBD            | Based on event volume       |
| Ingredients      | Coffee, milk, etc.  | TBD            | Based on menu and volume |
| Marketing        | Flyers, social media ads | TBD        | Based on strategy           |
| Misc             | TBD                 | TBD            |                             |   
